...
export default function TVShows() {
  const [selectedCategory, setSelectedCategory] = useState<TVCategory>('popular');
  ...
  if (error) {
    return (
      <div className="text-center py-12">
        ...
        <h2 className="text-xl font-semibold text-foreground mb-2">Error loading TV shows</h2>
