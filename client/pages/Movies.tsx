...
import { usePopularMovies, useTopRatedMovies, useUpcomingMovies } from '@/hooks/useTMDb';
  ...
  if (error) {
    return (
      <div className="text-center py-12">
        ...
        <h2 className="text-xl font-semibold text-foreground mb-2">Error loading movies</h2>
